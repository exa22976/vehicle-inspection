...
<div class="space-y-6" x-data="{ department_selection: '{{ old('department_id', $user->department_id ?? 'existing') }}' }">
    ...
    <div>
        ...
        <select name="department_id" id="department_id" x-model="department_selection" :disabled="department_selection === 'new'" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
